                    ...
                    <div class="row">
                        <div class="col-12 col-md-8">
                            ...
                            <div class="form-group mb-3 ">
                                ...
                                <textarea name="description" id="post-description" rows="10" class="form-control "></textarea>
                            </div>
                        </div>
                                ...
                                <h4>
                                    ...
                                    <?php foreach(listCategory() as $list) { ?>
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="radio" name="category_id" id="radio<?php echo $list['id']; ?>" value="<?php echo $list['id']; ?>">
